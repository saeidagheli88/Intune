...
# Run reg.exe with $ErrorActionPreference temporarily 'Continue'. Under 'Stop',
# PS 5.1 turns a native command's redirected stderr into a TERMINATING
# NativeCommandError -- reg.exe's stderr lines surfaced in the field as fatal
# "ERROR: Invalid key name." / "ERROR: The parameter is incorrect." runs.
